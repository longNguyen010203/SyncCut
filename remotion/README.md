...
For the full SyncCut pipeline, including Python setup, timeline generation, audio preparation, optional local visual assets, preflight, and artifact policy, start with the root [README.md](../README.md).
